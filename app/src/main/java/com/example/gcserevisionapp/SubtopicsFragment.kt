...
class SubtopicsFragment : Fragment() {
    ...
    private var _binding: FragmentSubtopicsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSubtopicsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = SubtopicsAdapter(requireContext())
